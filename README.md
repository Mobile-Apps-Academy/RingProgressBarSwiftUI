...
A apple ring progress bar, Developed using SwiftUI.
...
1. Clone the repo
   ```sh
   git clone https://github.com/Mobile-Apps-Academy/RingProgressBarSwiftUI.git
   ```
### Usage

1. How to create the ring progress bar view

```swift

@State var progressOne: CGFloat = 0.9
@State var progressTwo: CGFloat = 0.5
@State var progressThree: CGFloat = 0.7
    
VStack {
    RingProgressBar(animateTheRings: $drawingStroke, progressValueOne: $progressOne, progressValueTwo: $progressTwo, progressValueThree: $progressThree)
}
